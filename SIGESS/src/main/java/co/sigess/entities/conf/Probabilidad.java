...
@Table(name = "probabilidad", schema = "conf")
@XmlRootElement
public class Probabilidad implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @SequenceGenerator(name = "probabilidad_id_seq", schema = "conf", sequenceName = "probabilidad_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "probabilidad_id_seq")
    ...
    public Probabilidad(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "co.sigess.entities.conf.Probabilidad[ id=" + id + " ]";
    }
