...
public class Fuente implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "fuente_id_seq", schema = "ipr", sequenceName = "fuente_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fuente_id_seq")
    ...
    public String toString() {
        return "co.sigess.entities.ipr.Fuente[ id=" + id + " ]";
    }
